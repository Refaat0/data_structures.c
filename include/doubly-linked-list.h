...
/**
 * this function inserts an element to an index in a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
...
/**
 * this functions inserts a DoublyLinkedList to an index in another DoublyLinkedList
 ...
 * @return                  a boolean of true if the operation is successful
 */
bool dll_insert_dll(DoublyLinkedList *linked_list_alpha, DoublyLinkedList *linked_list_bravo, int index);

/**
 * this function inserts an element to the start of a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @param element a void pointer to an element
 * @return a boolean of true if the operation is successful
 */
...
/**
 * this function inserts an element to the end of a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @param element a void pointer to an element
 * @return a boolean of true if the operation is successful
 */
...
/**
 * this function removes removes an element at an index of a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
...
/**
 * this function removes an element at the end of a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @return a boolean of true if the operation is successful
 */
...
/**
 * this function removes an element from a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @param element a void pointer to an element
 * @return a boolean of true if the operation is successful
 */
...
/**
 * this function removes all elements from a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @return a boolean of true if the operation is successful
 */
...
/**
 * this function checks if a DoublyLinkedList is empty
 * @param linked_list a pointer to a DoublyLinkedList structure
...
/**
 * this function checks if an element is in a DoublyLinkedList
 * @param linked_list a pointer to a DoublyLinkedList structure
 * @param element a void pointer to an element
...
/**
 * this function finds the zero-based index of the element in a DoublyLinkedList,
...
/**
 * this function returns the element in a DoublyLinkedList at the index
 * @param linked_list a pointer to DoublyLinkedList structure
 * @param index an index in this DoublyLinkedList
...
/**
 * this function sets the index in a DoublyLinkedList to the element
 * @param linked_list a pointer to DoublyLinkedList structure
 * @param element a void pointer to an element
 * @param index an index in this DoublyLinkedList\
 * @return a boolean of true if the operation is successful
